...
class octoberfragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_octoberfragment, container, false)
        dataqueue = ArrayList()
        val adapter = calendaradapter(dataqueue!!)
        db = FirebaseFirestore.getInstance()
        db!!.collection("October").get().addOnSuccessListener { queryDocumentSnapshots ->
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): octoberfragment {
            val fragment = octoberfragment()
            val args = Bundle()
