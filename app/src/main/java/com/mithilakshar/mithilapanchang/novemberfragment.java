...
public class novemberfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_novemberfragment, container, false);
        ...
        db.collection("November").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
