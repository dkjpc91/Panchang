...
public class augustfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_augustfragment, container, false);
        ...
        db.collection("August").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
