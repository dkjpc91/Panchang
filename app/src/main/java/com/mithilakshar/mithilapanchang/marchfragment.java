...
public class marchfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_marchfragment, container, false);
        ...
        db.collection("March").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
