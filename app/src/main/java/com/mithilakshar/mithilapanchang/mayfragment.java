...
public class mayfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mayfragment, container, false);
        ...
        db.collection("May").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
