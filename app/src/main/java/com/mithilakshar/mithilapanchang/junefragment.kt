...
class junefragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_junefragment, container, false)
        dataqueue = ArrayList()
        val adapter = calendaradapter(dataqueue!!)
        db = FirebaseFirestore.getInstance()
        db!!.collection("June").get().addOnSuccessListener { queryDocumentSnapshots ->
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): junefragment {
            val fragment = junefragment()
            val args = Bundle()
