...
public class octoberfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_octoberfragment, container, false);
        ...
        db.collection("October").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
