 ...
 * Use the {@link Januaryfragment#newInstance} factory method to
...
public class Januaryfragment extends Fragment {
    ...
    public static Januaryfragment newInstance(String param1, String param2) {
        Januaryfragment fragment = new Januaryfragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_januaryfragment, container, false);
        ...
        db.collection("January").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
