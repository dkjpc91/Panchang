...
public class septemberfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_septemberfragment, container, false);
        ...
        db.collection("September").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
