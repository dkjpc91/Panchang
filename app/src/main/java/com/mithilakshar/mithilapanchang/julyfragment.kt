...
class julyfragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_julyfragment, container, false)
        dataqueue = ArrayList()
        val adapter = calendaradapter(dataqueue!!)
        db = FirebaseFirestore.getInstance()
        db!!.collection("July").get().addOnSuccessListener { queryDocumentSnapshots ->
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): julyfragment {
            val fragment = julyfragment()
            val args = Bundle()
