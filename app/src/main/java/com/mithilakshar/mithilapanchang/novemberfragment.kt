...
class novemberfragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_novemberfragment, container, false)
        dataqueue = ArrayList()
        val adapter = calendaradapter(dataqueue!!)
        db = FirebaseFirestore.getInstance()
        db!!.collection("November").get().addOnSuccessListener { queryDocumentSnapshots ->
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): novemberfragment {
            val fragment = novemberfragment()
            val args = Bundle()
