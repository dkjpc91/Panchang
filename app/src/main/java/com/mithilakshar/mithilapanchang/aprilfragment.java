...
public class aprilfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_aprilfragment, container, false);
        ...
        db.collection("April").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
