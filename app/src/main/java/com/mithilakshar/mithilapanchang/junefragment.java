...
public class junefragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_junefragment, container, false);
        ...
        db.collection("June").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
