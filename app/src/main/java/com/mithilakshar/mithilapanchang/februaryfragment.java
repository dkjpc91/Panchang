 ...
 * Use the {@link februaryfragment#newInstance} factory method to
...
public class februaryfragment extends Fragment {
    ...
    public static februaryfragment newInstance(String param1, String param2) {
        februaryfragment fragment = new februaryfragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_februaryfragment, container, false);
        ...
        db.collection("February").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
