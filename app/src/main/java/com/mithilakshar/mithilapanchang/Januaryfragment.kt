...
class Januaryfragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_januaryfragment, container, false)
        dataqueue = ArrayList()
        val adapter = calendaradapter(dataqueue!!)
        db = FirebaseFirestore.getInstance()
        db!!.collection("January").get().addOnSuccessListener { queryDocumentSnapshots ->
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): Januaryfragment {
            val fragment = Januaryfragment()
            val args = Bundle()
